<?php
require 'db_connect.php';  // データベース接続ファイルをインクルード
...
try {
    ...
    $stmt = $pdo->prepare("INSERT INTO gs_bm_table (company_name, email, industory, company_size, average_prpduts, inspection_method, current_challenges, interest, benefits, check_items, budget, adpption, concerns, current_software, support_needs, priority, created_at) VALUES (:company_name, :email, :industry, :company_size, :average_products, :inspection_method, :current_challenges, :interest, :benefits, :check_items, :budget, :adoption, :concerns, :current_software, :support_needs, :priority, NOW())");
